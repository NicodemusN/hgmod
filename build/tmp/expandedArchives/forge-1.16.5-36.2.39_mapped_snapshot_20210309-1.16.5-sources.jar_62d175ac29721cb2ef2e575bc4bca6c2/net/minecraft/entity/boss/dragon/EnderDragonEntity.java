...
public class EnderDragonEntity extends MobEntity implements IMob {
   ...
   public EnderDragonEntity(EntityType<? extends EnderDragonEntity> type, World worldIn) {
      ...
      this.setEntityId(NEXT_ENTITY_ID.getAndAdd(this.dragonParts.length + 1) + 1); // Forge: Fix MC-158205: Make sure part ids are successors of parent mob id
   }
   ...
   public void setEntityId(int id) {
      ...
      for(int i = 0; i < this.dragonParts.length; ++i) // Forge: Fix MC-158205: Set part ids to successors of parent mob id
         this.dragonParts[i].setEntityId(id + i + 1);
   }
