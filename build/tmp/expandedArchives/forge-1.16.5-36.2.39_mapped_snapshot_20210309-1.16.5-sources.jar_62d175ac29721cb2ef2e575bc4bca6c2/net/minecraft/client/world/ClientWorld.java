...
public class ClientWorld extends World {
   ...
   private void addEntityImpl(int entityIdIn, Entity entityToSpawn) {
      ...
      if (entityToSpawn.isMultipartEntity()) {
         for(net.minecraftforge.entity.PartEntity<?> part : entityToSpawn.getParts()) {
            this.partEntities.put(part.getEntityId(), part);
         }
      }
   }
   ...
   private void removeEntity(Entity entityIn) {
      ...
      if (entityIn.isMultipartEntity()) {
         for(net.minecraftforge.entity.PartEntity<?> part : entityIn.getParts()) {
            this.partEntities.remove(part.getEntityId());
         }
      }
   }
